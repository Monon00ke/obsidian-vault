...
| # | Тема | Файл |
|---|------|------|
| 6 | [[06 - File Signature Checker\|File Signature Checker]] | Определение типа файла по магическим байтам |
| 8 | [[08 - sed and awk Exercises\|sed & awk Exercises]] | Обработка текстовых потоков |
| 9-10 | [[09-10 - Users and Permissions\|Users & Permissions]] | Управление пользователями и правами |
